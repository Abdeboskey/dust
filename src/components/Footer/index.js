...
const Footer = () => {
  const [emailText, setEmailText] = useState('denverurbanskatetroop@gmail.com');

  const displayCopyMessage = () => {
    navigator.clipboard.writeText('denverurbanskatetroop@gmail.com');
    setEmailText('Address Copied!');
    setTimeout(() => { 
      setEmailText('denverurbanskatetroop@gmail.com');
    }, 2000);
  };
    ...
    <footer className="text-center lg:text-left bg-gray-200 text-gray-600">
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <a
            href="https://discord.com/invite/FtUq99CPUB"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://github.com/Abdeboskey/dust"
            target="_blank"
            rel="noreferrer"
            className="text-gray-600 m-3"
          >
          ...
          >
            <svg
              ...
              data-prefix="fas"
              data-icon="envelope"
              className="hidden sm:block w-4 ml-3 mr-6"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
      ...
      <div className="text-center text-gray-900 p-6 bg-dusteal border-t-8 border-gray-900">
        <p className="font-semibold mb-4">© 2022 Denver Urban Skate Troop</p>
        <p>
          📸: all photos by{" "}
